...
for scenario in scenarios:
    ...
    simulation_agents["state"] = "Belum Memilih"
...
st.subheader("🧠 Perbandingan Status Agent")

for scenario_name in scenarios:

    st.markdown(f"## {scenario_name}")

    scenario_data = latest_states[
        latest_states["scenario"] == scenario_name
    ]

    state_counts = scenario_data["state"].value_counts()
...
st.subheader("🥧 Perbandingan Final State")
